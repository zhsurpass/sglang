...
class TestNPUMimo_v2_flash_1P1D_16p_In32k_Out1_TTFT_5s(
    TestAscendPerfMultiNodePdSepTestCaseBase
):
    """Test NPU performance for mimo_v2_flash 1P+1D 16p: input_len=32000, output_len=1, 0 cache, TTFT=5s"""
    ...
    def test_npu_mimo_v2_flash_1p1d_16p_in32k_out1_ttft_5s(self):
        """Run NPU performance test for 1P+1D 16p with 32k input, 1 output, 0 cache, TTFT=5s"""
        self.run_throughput()
