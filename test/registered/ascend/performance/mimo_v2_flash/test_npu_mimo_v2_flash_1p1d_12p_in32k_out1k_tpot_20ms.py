...
class TestNPUMimo_v2_flash_1P1D_16p_In32k_Out1k_TTFT_5s(
    TestAscendPerfMultiNodePdSepTestCaseBase
):
    """Test NPU performance for mimo_v2_flash 1P+1D 16p: input_len=32000, output_len=1000, 0 cache, TPOT=20ms"""
    ...
    def test_npu_mimo_v2_flash_1p1d_16p_in32k_out1k_tpot_20ms(self):
        """Run NPU performance test for 1P+1D 16p with 32k input, 1k output, 0 cache, TPOT=20ms"""
        self.run_throughput()
